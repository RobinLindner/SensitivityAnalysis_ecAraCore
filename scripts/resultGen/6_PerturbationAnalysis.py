...
from source import RESULT_DIR, MODEL_DIR, PERT_ESC_WIDE, PERT_FLUX_WIDE, PERT_CHANGES_WIDE, UNIPROT_ID_2_DATA, MODEL_ENZYME_2_PMET, ESC_DATA_WIDE, SUPP_FIG_DIR
...
def main():
    ...
    group_assignments.columns=["ESC non-zero in all runs","ESC non-zero in more than half","ESC non-zero in less than half","ESC zero in all runs"]
    ...
    ax.set_title("Enzymes in perturbation samples")
    fig.savefig(SUPP_FIG_DIR / "proportions_LE_perturbtation.png")
    ...
    categ_dict = {"Persistent":"Persistent", 
                "Primary limiting": "T-specific",
                "Secondary limiting":"Spurious"}
